            ...
            <v-col sm="10" class="mx-auto">
                <v-card class="pa-5">
                    ...
                    <v-form ref="form" @submit.prevent="submitForm" class="pa-5" enctype="multipart/form-data">
                        ...
                        <v-file-input label="Image" @change="selectFile" prepend-icon="mdi-image" :rules="rules" show-size counter multiple></v-file-input>
                        <v-btn type="submit" color="primary" class="mt-3">Add Posts</v-btn>
                    </v-form>
                </v-card>
            </v-col>
        </v-row>
